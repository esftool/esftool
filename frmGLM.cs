...
namespace ESFTool
{
    public partial class frmGLM : Form
    {
        ...
        private void PoissonRegression(frmProgress pfrmProgress, IMapLayer pMapLayer, string strLM, int nIDepen, String[] independentNames, string strNoramlName, int intDeciPlaces)
        {
            try
            {
